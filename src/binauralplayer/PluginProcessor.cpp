...
bool PluginProcessor::isInputChannelStereoPair (int /*index*/)
{
    return true;
}

bool PluginProcessor::isOutputChannelStereoPair (int /*index*/)
{
    return true;
}
...
bool PluginProcessor::silenceInProducesSilenceOut()
{
    return false;
}
